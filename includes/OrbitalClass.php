...
class UcOrbitalGateway {
  ...
  private function buildXML() {
    ...
    if ($server_environment != 'production') {
      ...
      $xml .= '<Request>';
      $xml .= '<NewOrder>';
      $xml .= '<OrbitalConnectionUsername>' . variable_get('uc_orbital_gateway_test_username') . '</OrbitalConnectionUsername>';
      $xml .= '<OrbitalConnectionPassword>' . variable_get('uc_orbital_gateway_test_password') . '</OrbitalConnectionPassword>';
      $xml .= '<IndustryType>' . $this->industryType . '</IndustryType>';
      $xml .= '<MessageType>' . $this->messageType . '</MessageType>';
      $xml .= '<BIN>' . $this->bin . '</BIN>';
      $xml .= '<MerchantID>' . variable_get('uc_orbital_gateway_merchant_id') . '</MerchantID>';
      ...
      $xml .= '<Request>';
      $xml .= '<NewOrder>';
      $xml .= '<OrbitalConnectionUsername>' . variable_get('uc_orbital_gateway_username') . '</OrbitalConnectionUsername>';
      $xml .= '<OrbitalConnectionPassword>' . variable_get('uc_orbital_gateway_password') . '</OrbitalConnectionPassword>';
      $xml .= '<IndustryType>' . $this->industryType . '</IndustryType>';
      $xml .= '<MessageType>' . $this->messageType . '</MessageType>';
      $xml .= '<BIN>' . $this->bin . '</BIN>';
      $xml .= '<MerchantID>' . variable_get('uc_orbital_gateway_merchant_id') . '</MerchantID>';
      $xml .= '<TerminalID>' . variable_get('uc_orbital_gateway_terminal_id') . '</TerminalID>';
